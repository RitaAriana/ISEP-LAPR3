...
import lapr.project.model.esinf.AdjacencyMatrixGraph;
import lapr.project.model.esinf.Edge;
...
public class MatrixGraphTest {
    ...
    public void initializeGraph() {
        instance = new AdjacencyMatrixGraph<>(true) ;
    }
    ...
    public void testCopyConstructor() {
        ...
        Graph<String,Integer> g = new AdjacencyMatrixGraph<>(instance);
    ...
    public void testIsDirected() {
        ...
        Assertions.assertTrue( instance.isDirected(), "result should be true");
        instance = new AdjacencyMatrixGraph<>(false);
        Assertions.assertFalse(instance.isDirected(), "result should be false");
    }
    ...
    public void testNumVertices() {
        ...
        Assertions.assertEquals(0, instance.numVertices(), "result should be zero");
        instance.addVertex("A");
        Assertions.assertEquals(1, instance.numVertices(), "result should be one");
        instance.addVertex("B");
        Assertions.assertEquals(2, instance.numVertices(), "result should be two");
    ...
    public void testVertices() {
        ...
        Assertions.assertEquals(0, instance.vertices().size(), "vertices should be empty");

        boolean resultado=instance.addVertex("A");
        Assertions.assertTrue(resultado);
        instance.addVertex("B");
        boolean result = instance.addVertex("A");
        Assertions.assertFalse(result);

        Collection<String> cs = instance.vertices();
        Assertions.assertEquals(2, cs.size(), "Must have 2 vertices");
        cs.removeAll(Arrays.asList("A","B"));
        Assertions.assertEquals(0, cs.size(), "Vertices should be A and B");

        instance.removeVertex("A");

        cs = instance.vertices();
        Assertions.assertEquals(1, cs.size(), "Must have 1 vertice1");
        cs.removeAll(Arrays.asList("B"));
        Assertions.assertEquals(0, cs.size(), "Vertice should be B");

        instance.removeVertex("B");
        cs = instance.vertices();
        Assertions.assertEquals(0, cs.size(), "Must not have any vertice");
    }
    /**
    ...
    public void testValidVertex() {
        ...
        for (String v : co)
            Assertions.assertTrue(instance.validVertex(v), "vertices should exist");


        Assertions.assertFalse(instance.validVertex("Z"), "vertice should not exist");
    }
    /**
    ...
    public void testKey() {
        ...
        Assertions.assertEquals(-1, instance.key("Z"), "vertice should not exist");
    }
    /**
    ...
    public void testAdjVertices() {
        ...
        boolean result;
        for (int i = 0; i < co.size(); i++) {
            result = instance.addEdge(co.get(i), cd.get(i), cw.get(i));
            assertTrue(result);
        }
        ...
        Assertions.assertEquals(2, cs.size(), "Num adjacents should be 2");
        cs.removeIf(s -> s.equals("B") || s.equals("C"));
        Assertions.assertEquals(0, cs.size(), "Adjacents should be B and C");

        cs = instance.adjVertices("B");
        Assertions.assertEquals(1, cs.size(), "Num adjacents should be 1");
        cs.removeIf(s -> s.equals("D"));
        Assertions.assertEquals(0, cs.size(), "Adjacents should be S");

        cs = instance.adjVertices("E");
        Assertions.assertEquals(2, cs.size(), "Num adjacents should be 2");
        cs.removeIf(s -> s.equals("D") || s.equals("E"));
        Assertions.assertEquals(0, cs.size(), "Adjacents should be D and E");
    }
    ...
    public void testNumEdges() {
        ...
        Assertions.assertEquals(0, instance.numEdges(), "result should be zero");

        instance.addEdge("A","B",1);
        Assertions.assertEquals(1, instance.numEdges(), "result should be one");

        instance.addEdge("A","C",2);
        Assertions.assertEquals(2, instance.numEdges(), "result should be two");
    ...
    public void testEdges() {
        ...
        Assertions.assertEquals(0, instance.edges().size(), "edges should be empty");

        for (int i = 0; i <co.size(); i++)
            instance.addEdge(co.get(i), cd.get(i), cw.get(i));

        Collection <Edge<String,Integer>> ced = instance.edges();
        Assertions.assertEquals(8, ced.size(), "Must have 8 edges");
        for (int i = 0; i <co.size(); i++) {
            int finalI = i;
            ced.removeIf(e -> e.getVOrig().equals(co.get(finalI)) && e.getVDest().equals(cd.get(finalI)) && e.getWeight().equals(cw.get(finalI)));
        }
        Assertions.assertEquals(0, ced.size(), "Edges should be as inserted");

        instance.removeEdge("A","B");
        ced = instance.edges();
        Assertions.assertEquals(7, ced.size(), "Must have 7 edges");
        ...
        ced = instance.edges();
        Assertions.assertEquals(6, ced.size(), "Must have 6 edges");
    ...
    public void testGetEdge() {
        ...
        Assertions.assertNull(instance.edge("A","E"), "edge should be null");
        Assertions.assertNull(instance.edge("D","B"), "edge should be null");
        instance.removeEdge("D","A");
        Assertions.assertNull(instance.edge("D","A"), "edge should be null");
    }
    ...
    public void testGetEdgeByKey() {
        ...
        Assertions.assertNull(instance.edge(instance.key("A"),instance.key("E")), "edge should be null");
        Assertions.assertNull(instance.edge(instance.key("D"),instance.key("B")), "edge should be null");
        instance.removeEdge("D","A");
        Assertions.assertNull(instance.edge(instance.key("D"),instance.key("A")), "edge should be null");
    }
    ...
    public void testOutDegree() {
        ...
        Assertions.assertEquals(-1, instance.outDegree("G"), "degree should be -1");
        Assertions.assertEquals(2, instance.outDegree("A"), "degree should be 2");
        Assertions.assertEquals(1, instance.outDegree("B"), "degree should be 1");
        Assertions.assertEquals(2, instance.outDegree("E"), "degree should be 2");
    }
    ...
    public void testInDegree() {
        ...
        Assertions.assertEquals(-1, instance.inDegree("G"), "degree should be -1");
        Assertions.assertEquals(1, instance.inDegree("A"), "degree should be 1");
        Assertions.assertEquals(3, instance.inDegree("D"), "degree should be 3");
        Assertions.assertEquals(2, instance.inDegree("E"), "degree should be 2");
    }
    ...
    public void testOutgoingEdges() {
        ...
        Assertions.assertEquals(2, coe.size(), "Outgoing edges of vert C should be 2");
        coe.removeIf(e -> e.getWeight()==4 || e.getWeight()==5);
        Assertions.assertEquals(0, coe.size(), "Outgoing edges of vert C should be 4 and 5");

        coe = instance.outgoingEdges("E");
        Assertions.assertEquals(2, coe.size(), "Outgoing edges of vert E should be 2");
        coe.removeIf(e -> e.getWeight() == 7 || e.getWeight() == 8);
        Assertions.assertEquals(0, coe.size(), "Outgoing edges of vert E should be 7 and 8");

        instance.removeEdge("E","E");

        coe = instance.outgoingEdges("E");
        Assertions.assertEquals(1, coe.size(), "Outgoing edges of vert E should be 1");
        coe.removeIf(e -> e.getWeight() == 7);
        Assertions.assertEquals(0, coe.size(), "Outgoing edges of vert E should be 7");

        instance.removeEdge("E","D");

        coe = instance.outgoingEdges("E");
        Assertions.assertEquals(0, coe.size(), "Outgoing edges of vert E should be empty");
    }
    ...
    public void testEquals() {
        ...
        AdjacencyMatrixGraph<String,Integer> otherInst =new AdjacencyMatrixGraph<>(true) ;
        for (int i = 0; i <co.size(); i++)
        ...
        Assertions.assertNotEquals(instance, otherInst, "Graphs should NOT be equal");
