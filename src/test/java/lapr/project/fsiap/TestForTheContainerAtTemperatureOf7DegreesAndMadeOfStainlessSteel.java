...
public class TestForTheContainerAtTemperatureOf7DegreesAndMadeOfStainlessSteel{
    ...
    public void us412() throws IOException {
        ...
        Container container = App.getInstance().getCompany().getContainerStore().getContainerByIsoCode("5294-0:TF");
        ...
        double expectedResult = 2311307.90;
    ...
    public void us413() throws IOException {
        ...
        importContainers.getFile("ContainersUs413.csv");
        importContainers.convertContainers();
        Container container = App.getInstance().getCompany().getContainerStore().getContainerByIsoCode("2068-8:HR");
        heatFlow = new HeatFlow();
        heatFlow.calculateArea(container.getLength(), container.getHeight(), container.getWidth());
        ...
        double expectedResult = 111416893.73297003;
        double result = heatFlow.getTotalEnergy();
