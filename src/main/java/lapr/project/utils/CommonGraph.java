...
public abstract class CommonGraph<V, E> implements Graph<V,E> {
    ...
    /**
     * Designates whether the graph is directed
     */
    protected final boolean isDirected;

    /**
     * list with all its vertices
     * Used to maintain a numeric key to each verte
     */
     ...
     * @param otherObj other graph to test for equality
