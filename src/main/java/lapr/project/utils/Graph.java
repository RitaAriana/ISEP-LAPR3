...
public interface Graph<V,E>  extends Cloneable {
    ...
    /**
     * Finds the edge from vOrig to vDest, or null if vertices are not adjacent or don't exist
    ...
    /**
     * Finds the number of edges leaving vertex v
     * For an undirected graph, outDegree = inDegree
